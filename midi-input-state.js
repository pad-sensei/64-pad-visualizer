...
if (typeof window !== 'undefined') {
  ...
  if (typeof document !== 'undefined' && document.readyState === 'loading'
    ...
    var versionMatch = currentScriptSrc && currentScriptSrc.match(/[?&]v=([^&]+)/);
    var assetVersion = versionMatch ? '?v=' + versionMatch[1] : '';
    document.write('<script src="pad-core/observed-structure.js' + assetVersion + '"><\/script>');
    document.write('<script src="observed-ust-consumer.js' + assetVersion + '"><\/script>');
  }
}
