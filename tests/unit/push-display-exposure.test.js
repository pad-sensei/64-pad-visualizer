...
describe('v1.8.1 Push Display exposure contract', () => {
  ...
  it('invalidates the preview through its SW generation while retaining matching asset URLs', () => {
    expect(index).toContain('push-display-webusb-app.js?v=webusb-20260915-headline-layout1');
    expect(sw).toContain("'push-display-webusb-app.js?v=webusb-20260915-headline-layout1'");
    expect(sw).toContain("var CACHE_NAME = '64pad-v181-preview-20260915-flat-slash-1';");
