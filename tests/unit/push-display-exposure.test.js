...
describe('v1.8.0 Push Display exposure contract', () => {
  ...
  it('invalidates the preview through its SW generation while retaining matching asset URLs', () => {
    expect(index).toContain('push-display-webusb-app.js?v=webusb-20260913-active-color');
    expect(sw).toContain("'push-display-webusb-app.js?v=webusb-20260913-active-color'");
    ...
    expect(sw).toContain("var CACHE_NAME = '64pad-v180-preview-20260913-active-color';");
