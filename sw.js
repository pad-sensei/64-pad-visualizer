var CACHE_NAME = '64pad-v181-preview-20260915-flat-slash-1';
var ASSETS = [
  './',
  'index.html',
  'style.css?v=6.7.52',
  ...
  'render.js?v=1.8.0-chord-pad-led',
  'builder.js?v=1.8.0-parity2',
  'pad-core/observed-structure.js?v=6.7.52',
  'observed-ust-consumer.js?v=6.7.53',
  'midi-input-state.js?v=6.7.53',
  ...
  'push-display-webusb-app.js?v=webusb-20260915-headline-layout1',
